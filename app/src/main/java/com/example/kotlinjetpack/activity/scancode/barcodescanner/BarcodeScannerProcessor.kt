...
import com.example.kotlinjetpack.activity.scancode.barcodescanner.VisionProcessorBase
  ...
  init {
    ...
    barcodeScanner =
      if (zoomCallback != null) {
        val options =
          BarcodeScannerOptions.Builder()
            .setZoomSuggestionOptions(ZoomSuggestionOptions.Builder(zoomCallback).setMaxSupportedZoomRatio(5f).build())
            .build()
